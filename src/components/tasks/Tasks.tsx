     ...
     return (
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {atasks.splice(0,5).map((tech, index) => (
            <div
              key={index}
            ...
            >
              <div className="mb-8">
                <div
                  className="radial-progress text-accent border-4 border-accent"
                  style={{ "--value": tech.completed ? "100" : "10", "--size": "7rem" } as React.CSSProperties}
                  >
                  <Image 
                    src={tech.completed ?
                      done : not}
